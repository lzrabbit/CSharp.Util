...
namespace CSharp.Util.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        public T ExecuteDataRow<T>(string commandText, params SqlParameter[] parms)
           where T : new()
        {
        ...
        public List<T> ExecuteDataTable<T>(string commandText, params SqlParameter[] parms)
           where T : new()
        {
        ...
        public static T ExecuteDataRow<T>(string connectionString, string commandText, params SqlParameter[] parms)
           where T : new()
        {
        ...
        public static List<T> ExecuteDataTable<T>(string connectionString, string commandText, params SqlParameter[] parms)
          where T : new()
        {
        ...
        public static SqlDataReader ExecuteDataReader(string connectionString, string sql, string order, int pageSize, int pageIndex, SqlParameter[] parms = null, string query = null, string cte = null)
        {
            string psql = string.Format(@"
                                        {3}
                                        SELECT  *
            ...
            if (parms != null) paramlist.AddRange(parms);
            return ExecuteDataReader(connectionString, psql, paramlist.ToArray());
        }
